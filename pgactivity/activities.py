...
def sorted(processes: List[T], *, key: SortKey, reverse: bool = False) -> List[T]:
    ...
    ...         query=memoryview("UPDATE pgbench_accounts SET abalance = abalance + 3062 WHERE aid = 1932841;".encode("utf8")),
    ...         duration=0.1,
    ...         wait="ClientRead",
    ...         io_wait=False,
    ...
    ...         write=0.282_725_318_098_656_75,
    ...         state="idle in transaction",
    ...         query=memoryview("UPDATE pgbench_accounts SET abalance = abalance + 141 WHERE aid = 7289374;".encode("utf8")),
    ...         duration=0.1,
    ...         wait="ClientRead",
    ...         io_wait=False,
